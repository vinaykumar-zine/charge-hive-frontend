...
// /**
//  * Modal dialog for adding a new port to a station.
//  */
// const AddPortModal = ({ isOpen, onClose, station, onAddPort }) => {
//     const [portType, setPortType] = useState('Type 2');
//     const [portPower, setPortPower] = useState('');
...
//         e.preventDefault();
//         if (!portPower || !station) {
//             console.error("Port power and station are required.");
//             return;
//         }
//         const newPort = { type: portType, power: `${portPower} kW`, status: 'Available' };
//         onAddPort(station.id, newPort);
//     };
...
//                     <h2 className="text-2xl font-bold text-gray-800">Add Port to {station?.name}</h2>
//                     <button onClick={onClose} className="text-gray-400 hover:text-gray-600"><X size={24} /></button>
//                 </div>
//                 <form onSubmit={handleSubmit}>
//                     <div className="space-y-4">
//                         <div>
//                             <label htmlFor="portType" className="block text-sm font-medium text-gray-700 mb-1">Port Type</label>
//                             <select id="portType" value={portType} onChange={(e) => setPortType(e.target.value)} className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
...
//                         </div>
//                         <div>
//                             <label htmlFor="portPower" className="block text-sm font-medium text-gray-700 mb-1">Power (kW)</label>
//                             <input type="number" id="portPower" value={portPower} onChange={(e) => setPortPower(e.target.value)} placeholder="e.g., 50" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" />
//                         </div>
//                     </div>
...
/**
 * Modal dialog for adding a new port to a station, compatible with the DTO.
 */
