            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold">EVStation Admin</span>
                        </div>
                        <p className="text-gray-400 mb-4 max-w-md">
                            Leading the future of electric vehicle charging management with innovative solutions and reliable technology.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/dashboard" className="text-gray-400 hover:text-green-400 transition">Dashboard</Link></li>
                            <li><Link to="/stations" className="text-gray-400 hover:text-green-400 transition">Stations</Link></li>
                            <li><Link to="/bookings" className="text-gray-400 hover:text-green-400 transition">Bookings</Link></li>
                            <li><Link to="/earnings" className="text-gray-400 hover:text-green-400 transition">Analytics</Link></li>
                        </ul>
                    </div>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm">
                        © 2024 EVStation Admin. All rights reserved.
                    </p>
